...
public class HistoryListActivity extends AppCompatActivity {
    ...
    private static final String DBRequest_URL = "https://doowa-server.herokuapp.com/filterRequestHistory.php";
            ...
            public void run() {
                ...
                if (putData.startPut()) {
                    if (putData.onComplete()) {
                        ...
                        Toast.makeText(HistoryListActivity.this,"Error during data retrieval", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            adapter = new HistoryListAdapter(HistoryListActivity.this, requestList);
                            recyclerView.setAdapter(adapter);
                            if(requestList.size()==0)
                                Toast.makeText(HistoryListActivity.this, "Your submission history is empty!", Toast.LENGTH_SHORT).show();
