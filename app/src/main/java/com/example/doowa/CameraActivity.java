...
public class CameraActivity extends AppCompatActivity {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    prefs.edit().putString("image", imageUrl).commit();
                                    finish();
                                }
                            });
    ...
    private void getUrlAsync (){
        ...
        StorageReference dateRef = storageRef.child("/uploads");
        dateRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>()
        {
            @Override
            public void onSuccess(Uri downloadUrl)
            {
                url.setText(downloadUrl.toString());
            }
        });
    }
    ...
    private void confirmationWindow() {
        ...
        builder.setMessage("Are your sure to upload this image?");
